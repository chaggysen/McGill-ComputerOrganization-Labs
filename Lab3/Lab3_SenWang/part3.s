...
draw_real_life_flag:
        push    {r4, lr}
        bl      draw_vietnam_flag
        pop     {r4, pc}

@ TODO: adapt this function to draw an imaginary flag of your choice.
draw_imaginary_flag:
        push    {r4, lr}
        bl      draw_double_vietnam_flag
        pop     {r4, pc}

draw_vietnam_flag:
		push    {r4, lr}
        sub     sp, sp, #8
        ldr     r3, .flags_vietnam
        str     r3, [sp]
        mov     r3, #240
        mov     r2, #320
        mov     r1, #0
...
.flags_vietnam:
		.word   45248 // red color
		.word   65280 // yellow color
		.word   0
.flags_L32:
        .word   2911
        .word   65535
